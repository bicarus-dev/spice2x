...
static LONG WINAPI SetWindowLongA_hook(HWND hWnd, int nIndex, LONG dwNewLong) {
    ...
    if (nIndex == GWL_STYLE && (dwNewLong & WS_VISIBLE)) {
        close_splash_for_visible_window(hWnd, "SetWindowLongA");
    }
    return result;
}
...
static LONG WINAPI SetWindowLongW_hook(HWND hWnd, int nIndex, LONG dwNewLong) {
    ...
    if (nIndex == GWL_STYLE && (dwNewLong & WS_VISIBLE)) {
        close_splash_for_visible_window(hWnd, "SetWindowLongW");
    }
    return result;
}
